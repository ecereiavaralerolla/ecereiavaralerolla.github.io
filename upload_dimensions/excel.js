(function() {
    ...
    class Excel extends HTMLElement {
        ...
        onCustomWidgetAfterUpdate(changedProperties) {
            ...
            let xlsxjs = "https://ecereiavaralerolla.github.io/xlsx.js";
                    ...
                    onValidate: function (e) {
                        ...
                        reader.onload = async function (e) {
                            ...
                            if (correctsheet) {
                                ...
                                for(var t=1;t<=number_of_columns;t++) {
                                    dimensions_array.push("Dimensione"+t)
                                }

                                var len = 0;
                                if (lengthfield == number_of_columns) {
                                    for (var i = 1; i < result.split("[$@~!~@$]").length; i++) {
                                        if (result.split("[$@~!~@$]")[i].length > 0) {
                                            ...
                                            if (rec.length > 0) {
                                                len = 0;
                                                for(var t=0;t<number_of_columns;t++) {
                                                    len += rec[t].trim().length;
                                                }
